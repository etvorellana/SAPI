...
#					columns=['Desvio Padrão', 'Min'])
df = pd.DataFrame(np.column_stack([kfold_treino]), 
					columns=['Soma', 'Media', 'Desvio Padrão', 'Min', 'Max'])
df.to_csv('DctKF1.csv', encoding='utf-8', index=False)
...
df = pd.DataFrame(np.column_stack([kfold_teste]), 
					columns=['Soma', 'Media', 'Desvio Padrão', 'Min', 'Max'])
df.to_csv('DctKF1t.csv', encoding='utf-8', index=False)
...
df = pd.DataFrame(np.column_stack([kfold_treino]), 
					columns=['Soma', 'Media', 'Desvio Padrão', 'Min', 'Max'])
df.to_csv('DctKF2.csv', encoding='utf-8', index=False)
...
df = pd.DataFrame(np.column_stack([kfold_teste]), 
					columns=['Soma', 'Media', 'Desvio Padrão', 'Min', 'Max'])
df.to_csv('DctKF2t.csv', encoding='utf-8', index=False)
...
df = pd.DataFrame(np.column_stack([kfold_treino]), 
					columns=['Soma', 'Media', 'Desvio Padrão', 'Min', 'Max'])
df.to_csv('DctKF3.csv', encoding='utf-8', index=False)
...
df = pd.DataFrame(np.column_stack([kfold_teste]), 
					columns=['Soma', 'Media', 'Desvio Padrão', 'Min', 'Max'])
df.to_csv('DctKF3t.csv', encoding='utf-8', index=False)
...
df = pd.DataFrame(np.column_stack([kfold_treino]), 
					columns=['Soma', 'Media', 'Desvio Padrão', 'Min', 'Max'])
df.to_csv('DctKF4.csv', encoding='utf-8', index=False)
...
df = pd.DataFrame(np.column_stack([kfold_teste]), 
					columns=['Soma', 'Media', 'Desvio Padrão', 'Min', 'Max'])
df.to_csv('DctKF4t.csv', encoding='utf-8', index=False)
...
df = pd.DataFrame(np.column_stack([kfold_treino]), 
					columns=['Soma', 'Media', 'Desvio Padrão', 'Min', 'Max'])
df.to_csv('DctKFT.csv', encoding='utf-8', index=False)
...
df = pd.DataFrame(np.column_stack([kfold_teste]), 
					columns=['Soma', 'Media', 'Desvio Padrão', 'Min', 'Max'])
df.to_csv('DctKFTt.csv', encoding='utf-8', index=False)


#df = pd.DataFrame(np.column_stack([images]), columns=['Soma', 'Media', 'Desvio Padrão', 'Min', 'Max'])
#df = pd.DataFrame(np.column_stack([images]), 
#					columns=['Media', 'Desvio Padrão', 'Min'])
#print(df.head(28))
